...
static const char* cal_tweet_vec_inputs[] = {"near_washington_1015_1016_tweets.csv.2020-10-15.txt",
...
static const char* cal_tweet_vec_outputs[] = {"2020-10-15.txt", "2020-10-16.txt", "2020-10-17.txt",
                         "2020-10-18.txt", "2020-10-19.txt", "2020-10-20.txt", "2020-10-21.txt"};
static const int number_of_cal_tweet_vec_files = 7;
